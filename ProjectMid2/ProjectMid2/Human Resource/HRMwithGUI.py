...
icon = ImageTk.PhotoImage(Image.open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\dreamcatcher.png"))
...
icon2 = ImageTk.PhotoImage(Image.open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\dreamcatcher2.png"))
...
def check_user_account(username, password):
    ...
    f1 =open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Staff_s.pickle", "rb")    # Read Staff_s.picke 
    temp = pickle.load(f1)
    f1.close()
    f2 =open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Manager.pickle", "rb")   # Read Manager.pickle
    temp.append(pickle.load(f2))
    f2.close()
    
    if not any (obj.id == username for obj in temp):                    # temp = Staff_s + Manager
