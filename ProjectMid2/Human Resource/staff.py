...
def add_employee(id, name, gender, DoB, office, frame, window_s):       # Add employee info to e_list
    try:
        f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Employee{}.pickle".format(office), "rb")     # Read Employee{office}.pickle
        e_list = pickle.load(f)
        f.close()
    except:
        e_list =[]      # Create new list if no data
    if ckF.prevent_duplicate(id.get(), e_list) == False:
        ...
        if ckF.check_gender(gender.get()) == False:
            ...
            if len(e_list) > 10 :
                ...
                f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Employee{}.pickle".format(office), "wb")
...
def del_employee(del_id, office, frame, window_s):
    f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Employee{}.pickle".format(office), "rb")     # Read file
    e_list = pickle.load(f)
    f.close()
        ...
        if float(working_hour.get()) > 200.0:
            ...
            try: 
                if float(wage.get()) > 9999.0:
                    ...
                    f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Salary{}.pickle".format(office), "wb")
...
def show_all_employee_salary(office, frame, window_s):                # Show p_list
    ...
    try:
        f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Salary{}.pickle".format(office), "rb")       # Read file
...
def update_staff_info(staff_lable, office, window_s):       # Update staff info
    ...
    def update(name, gender, DoB, password, office, window_s, staff_lable, temp):
        f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Staff{}.pickle".format(office), "rb")        # Read file
        staff = pickle.load(f)
        f.close()
        if ckF.check_gender(gender.get()) == False:
            ...
            try:
                ...
                f = open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Database\\Staff{}.pickle".format(office), "wb")
...
def main(office):
    ...
    icon3 = ImageTk.PhotoImage(Image.open("C:\\Users\\FLOS IGNIS\\OneDrive\\Máy tính\\Human Resource\\Staff.png"))
